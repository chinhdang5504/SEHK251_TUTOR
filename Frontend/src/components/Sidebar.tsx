...
const Sidebar = () => {
  ...
  if (isLoading) return null // <--- You can show a skeleton or loader instead --->
          ...
          {sidebarItem.map((item, index) => (
            ...
            >
              <div className='flex items-center gap-4'>
                <FontAwesomeIcon icon={item.icon} className='transition-transform duration-200 hover:scale-110' />
